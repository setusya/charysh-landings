      ...
      <div className="container">
        ...
        <div className="pc-speaker-grid">
          <figure className="pc-speaker-photo">
            <img src="assets/team/antonova.jpg" alt="Светлана Антонова — со-основатель Чарышских Усадеб"/>
...
function PCAltaiViability() {
  const scenarios = [
    ...
    {
      tag: 'Премиальный',
      sub: 'Высокий сезон + апартаменты с видом',
      adr: '~30 000 ₽',
      load: '70%',
      mix: 'премиум-mix + повышенная загрузка',
      year: '~1,32 млрд',
      cum: '~3,57 млрд',
      yearV: 1320,
      tone: 'ink',
...
function PCMasterPlan() {
  const sectors = [
    {
      n: '01', name: 'Чарышские Усадьбы',
      sub: 'Сердце посёлка',
      d: '150–200 гостевых домов на индивидуальных участках 6–7 соток. 4 функциональных подсектора — от долгосрочного проживания до апартаментов с видом на реку.',
      status: 'Проектируется',
    },
    {
      n: '02', name: 'Общественный центр',
      sub: 'Все объекты для жителей',
      d: 'Визит-центр, банный комплекс, фермерское кафе, smart cafe, ярмарка, прокат, спорт, водопад, КПП, парковка на 40 машин.',
      status: 'Проектируется',
    },
    {
      n: '03', name: 'Ретрит-зона',
      sub: '«Резиденция Чарыш»',
      d: 'Ретрит-центр, 4 двухэтажных гостевых дома, 11 одиночных + 5 дуплексов в лесу, банный комплекс с круглой баней до 30 человек, MICE-павильон.',
      status: 'Готов · студия 8 Lines',
    },
    {
      n: '04', name: 'Видовая зона «Гора»',
      sub: 'Высота над долиной',
      d: 'Smart cafe, 2–3 видовые беседки, костровище. Без жёсткой привязки к точке — гибкое размещение по рельефу.',
      status: 'Концепция',
    },
    {
      n: '05', name: 'Кластер горных лыж',
      sub: 'Зимний спорт',
      d: 'Горнолыжный склон примыкает к территории. Зимняя инфраструктура — основа 365-дневного сценария жизни.',
      status: 'Обозначено',
    },
    {
      n: '06', name: 'Конный двор',
  ...
  return (
    <section className="sec-pad sec-warm" id="masterplan" data-screen-label="03 Master Plan — 6 sectors">
      <div className="container">
        <div className="comm-head">
          <div className="crumb"><span className="num">10</span><span className="sep">|</span>Мастер-план</div>
          <h2 className="display h-display-l">
...
// ───────── Slide 2: Detailed breakdown — yearround anchors + residences + public center ─────────
function PCMasterPlanDetail() {
  const anchors = [
    {
      tag: 'Круглый год',
      name: 'Круглогодичный детский центр',
      sub: '~300 м² · школа года · кружки и студии',
      img: 'assets/photo/activity-farm-kitchen.jpg',
      d: 'Сердце «семейного» сценария посёлка. Работает зимой, когда другие курорты пустеют: образовательная программа, творческие студии, спорт, праздники. Даёт семьям повод оставаться месяцами, а не неделями.',
      points: [
        'Программа «школа года» — занятия для постоянных детей',
        'Утро/день/вечер — расписание под разные возрасты',
        'Зимняя анимация, праздники и тематические смены',
        'Связка с мастерскими — практика и творчество',
      ],
    },
    {
      tag: 'Ремесло',
      name: 'Мастерские',
      sub: 'Дерево · керамика · текстиль · кузня',
      img: 'assets/photo/activity-nature-watching.jpg',
      d: 'Открытые мастерские для резидентов и гостей. Дерево, керамика, текстиль, кузня — компетенции, которые живут в Чарыше исторически. Место, где взрослые учатся, дети наблюдают и пробуют, а лучшие работы становятся подарками.',
      points: [
        'Постоянные мастера-резиденты ведут программы',
        'Открытые мастер-классы для гостей курорта',
        'Стажировки и резиденции — приезжающие авторы',
        'Витрина-магазин: лучшие работы — на продажу',
      ],
    },
  ];
  const residences = {
  ...
  const publicCenter = {
    ...
    sub: 'Десять объектов вокруг центральной входной группы',
    blocks: [
      ...
      { tag: '04', name: 'Smart cafe · 100 м²', d: 'Бесконтактное самообслуживание. В жилой застройке — для быстрого перекуса в любое время.' },
      { tag: '05', name: 'Уличная ярмарка · 100 м²', d: 'Торговля фермерскими продуктами с локальных хозяйств.' },
      { tag: '06', name: 'Озеро · пляж · водные объекты', d: 'Лежаки, шезлонги, кабинки, песочница. Прогулочные дорожки, пирсы, искусственный водопад с подсветкой и акустикой.' },
      { tag: '07', name: 'Спортивные активности у пляжа', d: 'Падл-корты, воркаут-площадки, волейбол.' },
      { tag: '08', name: 'Прокатный центр · 70 м²', d: 'Мобильный склад на основе декоративно обшитого морского контейнера. SUP, каяки, вёсла, лыжи.' },
      { tag: '09', name: 'Гриль-беседки у реки', d: 'Панорамные смотровые беседки. По возможности.' },
      { tag: '10', name: 'Парковка · 40 машин', d: 'У центральной входной группы под охраной с КПП.' },
    ],
  };
  return (
    <section className="sec-pad" id="masterplan-detail" data-screen-label="03.5 Master Plan Detail">
      <div className="container">
        <div className="comm-head">
          <div className="crumb"><span className="num">11</span><span className="sep">|</span>Что внутри</div>
          <h2 className="display h-display-l">
            Сердце посёлка — <em className="redword">круглый год</em>.<br/>
            Где живут, где собираются, где остаются.
          </h2>
        </div>
        <p className="lead" style={{opacity:.78, maxWidth:'64ch', marginBottom:48}}>
          Это не&nbsp;сезонный курорт. Детский центр и&nbsp;мастерские работают зимой, объединяют резидентов и&nbsp;притягивают семьи на&nbsp;круглогодичные программы. Жилые и&nbsp;общественные зоны — поддержка этого ритма.
        </p>

        {/* Круглогодичные якоря — детский центр и мастерские */}
        <div className="pc-mp-anchors-grid">
          {anchors.map((a, i) => (
            <article className="pc-mp-anchor" key={i}>
              <div className="pc-mp-anchor-photo" style={{backgroundImage:`url('${a.img}')`}}>
                <div className="pc-mp-anchor-tag">{a.tag}</div>
              </div>
              <div className="pc-mp-anchor-body">
                <h3 className="pc-mp-anchor-name">{a.name}</h3>
                <div className="pc-mp-anchor-sub">{a.sub}</div>
                <p className="pc-mp-anchor-d">{a.d}</p>
                <ul className="pc-mp-anchor-list">
        ...
        <div className="pc-mp-zones-head">Жилые и&nbsp;общественные зоны</div>
...
function PCResidents() {
  const types = [
    {
      t: 'Высокоэффективная семья', age: '35–55 лет, дети школьного возраста',
      pts: ['Устали платить за успех качеством жизни', 'Дефицит не денег — а тишины и восстановления', 'Думают на 10–20 лет: семейный актив, не потребление']
    },
    {
      t: 'Семья из крупных городов', age: 'Москва · Петербург · Новосибирск',
      pts: ['Летний дом для городских жителей', 'Природный опыт для детей важнее репетиторов', 'Видели Европу — хотят такого же дома здесь']
    },
    {
      t: 'Творец и созерцатель', age: 'Тишина — рабочая среда',
      pts: ['Контакт с настоящим: без имитаций', 'Мягкая трансформация через ремесло и природу', 'Оздоровление жизнью, а не SPA-программами']
    },
    {
      t: 'Родитель новой волны', age: 'Природный опыт развития — выше репетиторов',
      pts: ['Казачья культура · ремёсла · живая история', 'Среда, в которой дети вырастают иначе', 'Сезонность и природные ритмы — настоящее воспитание']
    },
    {
      t: 'Искатель мест силы и ЗОЖ', age: 'Активный отдых на природе',
      pts: ['Горный треккинг, сплавы, рафтинг, велосипеды', 'Квадроциклы, падл-корты, воркаут у реки', 'Без семьи — есть сообщество равных духом']
    },
    {
      t: 'Предприниматели, управленцы, специалисты', age: 'Ценят локации с концепцией, душой и культурным кодом',
      pts: ['Высокооплачиваемые профессионалы, уставшие от шаблонных курортов', 'Ищут смысл и контекст — а не «всё включено»', 'Готовы платить за подлинность, а не за бренд', 'Сообщество равных по уровню и по ценностям']
    },
  ];
  return (
    <section className="sec-pad sec-warm" id="residents" data-screen-label="05 Residents">
      <div className="container">
        <div className="comm-head">
          <div className="crumb"><span className="num">09</span><span className="sep">|</span>Кто&nbsp;здесь&nbsp;живёт</div>
          <h2 className="display h-display-l">
...
function PCEconomics() {
  const stats = [
    { n: 'от 11,4', u: 'млн ₽', l: 'минимальный вход', sub: 'Для первых 5 клиентов' },
...
function PCWhatsBuilt() {
  const items = [
    { v: '200', u: 'млн ₽', l: 'собственных средств вложено', d: 'Реальный проект — не бизнес-план. Деньги вложены. Стройка начинается.' },
...
function PCRoadmap() {
  const stages = [
    {
      n: '1', when: '2025 – 2026', t: 'Проектирование',
      pts: ['Формирование концепции', 'Архитектурная концепция', 'Межевые работы', 'Инженерные решения и согласования', 'Строительство первых 20 домов', 'Дороги и коммуникации'],
    },
    {
      n: '2', when: '2026 – 2027', t: 'Первые 20 домов · открытие весна 2027',
      pts: ['Монтаж внешних сетей', 'Первые 20 домов · комплекс бань', 'Запуск управляющей компании', 'Создание сельхозкооператива проекта'],
    },
    {
      n: '3', when: '2027 – 2028', t: 'Основная застройка',
      pts: ['Строительство всего номерного фонда', 'Набережная, конный центр, детский центр', 'Спортивная инфраструктура'],
    },
    {
      n: '4', when: '2028+', t: 'Развитие',
      pts: ['Эксплуатация и приём гостей', 'Освоение горнолыжного склона', 'Создание природной академии', 'Развитие предпринимательства в районе', 'Формирование лидеров сообщества'],
    },
  ];
  return (
    <section className="sec-pad" id="roadmap" data-screen-label="12 Roadmap">
      <div className="container">
        ...
        <div className="pc-roadmap-grid">
          {stages.map((s, i) => (
            <div className={`pc-stage ${i === 0 ? 'pc-stage-active' : ''}`} key={i}>
      ...
      <div className="place-photo pc-showcase-photo" style={{ backgroundImage: "url('assets/photo/object-retreat.jpg')" }}>
        ...
        <div className="container place-photo-frame">
          ...
          <h2 className="display h-display-l place-photo-h">
            ...
            на 48 номеров — это&nbsp;то, что строит АО.<br/>
            Запуск — весна 2027.
          </h2>
          <div className="place-photo-cap">500 тыс&nbsp;₽ минимальный чек · 10–15% дивиденды · ×2 за&nbsp;5&nbsp;лет</div>
        </div>
      </div>
    </section>
  );
  ...
  const types = [
    {
      ...
      img: 'assets/photo/modular-house.jpg',
    ...
    },
    {
      ...
      months: 9,
      monthsLabel: 'месяцев',
      sub: 'Дом «на поколения»',
      img: 'assets/photo/house-belyak.png',
      d: 'Стационарный дом с полноценным фундаментом и инженерией. Подряд от&nbsp;команды проекта на&nbsp;месте.',
      points: [
...
function PCFormCEquity() {
  ...
  const objects = [
    ...
    },
    {
      ...
      img: 'assets/photo/house-kedr.png',
