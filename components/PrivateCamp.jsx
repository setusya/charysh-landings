...
function PCMasterPlanDetail() {
  ...
  return (
    <section className="sec-pad" id="masterplan-detail" data-screen-label="03.5 Master Plan Detail">
      <div className="container">
        <div className="comm-head">
          <div className="crumb"><span className="num">16</span><span className="sep">|</span>Что внутри</div>
          <h2 className="display h-display-l">
...
function PCResidents() {
  ...
  return (
    <section className="sec-pad sec-warm" id="residents" data-screen-label="05 Residents">
      <div className="container">
        <div className="comm-head">
          <div className="crumb"><span className="num">07</span><span className="sep">|</span>Кто&nbsp;здесь&nbsp;живёт</div>
          <h2 className="display h-display-l">
...
function PCSecurity() {
  const pillars = [
    ...
    {
      h: 'ДНК местного сообщества',
      pts: [
        'Поддержка чарышцев — мы рядом, а не «над»',
        'Местные мастера ведут программы и резиденции',
        'Сотрудничество с сельсоветом и старейшинами',
        'Хор «Канареечка» · амбассадоры культуры',
        'Своя ячейка КФХ — часть местной экономики',
      ],
    ...
    <section className="sec-pad sec-dark" id="security" data-screen-label="18 Why we are confident">
      <div className="container">
        ...
        <div className="pc-pillar-foot">
          <span className="pc-pillar-foot-meta">Полная команда и&nbsp;био — на&nbsp;слайде 11</span>
...
function PCTrends() {
  ...
  return (
    <section className="sec-pad" id="trends" data-screen-label="19 Trends fit">
      <div className="container">
        <div className="comm-head">
          <div className="crumb"><span className="num">17</span><span className="sep">|</span>На&nbsp;пересечении&nbsp;трендов</div>
          <h2 className="display h-display-l">
...
function PCWhatsBuilt() {
  ...
  return (
    <section className="sec-pad sec-dark" id="built" data-screen-label="11 Whats Built">
      <div className="container">
        <div className="comm-head">
          <div className="crumb"><span className="num">14</span><span className="sep">|</span>Что&nbsp;уже&nbsp;сделано</div>
          <h2 className="display h-display-l">
